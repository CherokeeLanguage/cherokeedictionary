...
%{--<option value="${Tense.RECENT_PAST_IMPERATIVE}">Present/Recent Past Imperative</option>--}%%{--
        ...
        <option value="${Tense.FUTURE_COMMAND}" <g:if test="${Tense.valueOf(verbTense) == Tense.FUTURE_COMMAND}">selected</g:if>>Immediate</option><%--<option value="${Tense.FUTURE_COMMAND}">Future Imperative</option>--%>
