...
class TimesSection extends BaseSection {
    TimesSection() {
        ...
        vocabulary."What time is it? (what hour is it)" = "Hila iyuwahnilv?"
        vocabulary."What time is it?" = "Hila atliili?"
        vocabulary."When are you going?" = "Hilayv tesi?"
        vocabulary."It is 8:00" = "Chanela iyuwahnilv."
        ...
        vocabulary."When will it end?" = "Hilayv dvl(i)sgwadi?"
        vocabulary."9:45 (fi fteen minutes before ten)" = "Sgigadu iyatawostanv udalula sgohi"
        vocabulary."10:15 (fi fteen minutes after ten)" = "Sgigadu iyatawostanv ulosvsdi sgohi"
