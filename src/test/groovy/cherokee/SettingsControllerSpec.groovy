...
class SettingsControllerSpec extends Specification implements ControllerUnitTest<SettingsController>, DomainUnitTest<Settings> {
    ...
    void "Test the save action with an invalid instance"() {
        given:
        controller.settingsService = Mock(SettingsService) {
            1 * save(_ as Settings) >> { Settings settings ->
                throw new ValidationException("Invalid instance", settings.errors)
            }
        }
    ...
    void "Test the show action with a valid id"() {
        ...
        model.settings instanceof Settings
    }
    ...
    void "Test the update action with an invalid instance"() {
        ...
        request.contentType = FORM_CONTENT_TYPE
        request.method = 'PUT'
        controller.update(new Settings())
