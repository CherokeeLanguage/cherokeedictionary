...
import cherokee.dictionary.CopyLikespreadsheetsToHistoryService
import cherokee.dictionary.History
...
//            println likespreadsheetsInstance
            render(view: "show", model: [likespreadsheetsInstance: likespreadsheetsInstance]);
        }
    }
...
//        respond likespreadsheetsInstance
            render(view: "create", model: [likespreadsheetsInstance: new Likespreadsheets(params)]);
        }
...
//    @Transactional
    def save(Likespreadsheets likespreadsheetsInstance) {
        ...
        if (likespreadsheetsInstance.hasErrors()) {
            respond likespreadsheetsInstance.errors, view:'create'
            return
        }
...
//        respond likespreadsheetsInstance
            render(view: "edit", model: [likespreadsheetsInstance: likespreadsheetsInstance]);
        }
    }
...
//    @Transactional
    def update(Likespreadsheets likespreadsheetsInstance) {
        ...
        if (likespreadsheetsInstance.hasErrors()) {
            ...
            respond likespreadsheetsInstance.errors, view:'edit'
            return
        }
...
//    @Transactional
    ...
    def simplifiedEntry(Likespreadsheets likespreadsheetsInstance) {
        ...
        if (!loggedin) {
            ...
            if (likespreadsheetsInstance == null) {
                render(view: "simplifiedEntry")
                return
            }

            if (likespreadsheetsInstance.hasErrors()) {
                respond likespreadsheetsInstance.errors, view: 'simplifiedEntry'
                return
            }
            ...
            render(view: "simplifiedEntry", model: [likespreadsheetsInstance: likespreadsheetsInstance])
        }
    }
