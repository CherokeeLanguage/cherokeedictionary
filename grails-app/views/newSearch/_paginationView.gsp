...
%{--    def backParams = params--}%

%{--    params.index = tmpIndex--}%

%{--//    if (tmpIndex == "40" || tmpIndex == 40) {--}%
%{--//        backParams.index = 0--}%
%{--//        backParams.goBackAPage = true--}%
%{--//    }--}%
%{--%>--}%
%{--<% if (params?.goBack) { %>--}%
%{--<g:link action="dictionary" controller="newSearch" params="${backParams}">Back</g:link> &nbsp;--}%
%{--<% } %><g:link action="dictionary" controller="newSearch" params="${params}">Next</g:link>--}%
%{--<g:paginate next="Forward" prev="Back"--}%
%{--            maxsteps="40" controller="newSearch"--}%
%{--            action="dictionary" total="${entries}" />--}%
<table>
