...
<g:clearCitations/>
<g:bookChapter anchor="${title}" title="Greetings - ${SyllabaryUtil.tsalagiToSyllabary("unalihelijeti")}">
    ...
    <g:bookSection title="Hello" phonetic="osiyo">
        In Cherokee there is only one way to say 'Good Morning,' 'Good Afternoon,' 'Good Evening,' and Hello; that is by saying <g:translit src="osiyo"/> <g:redSpan>(o)siyo</g:redSpan> or the shortened version <g:translit src="siyo"/> <g:redSpan>siyo</g:redSpan>.
        <br/>
    ...
    <g:bookSection title="Goodbye" phonetic="donadagohvi">
        ...
        <g:translit src="dodadagohvi"/> <g:redSpan>dodadagohvi</g:redSpan>.  Lit: Let's meet again.<br/>
