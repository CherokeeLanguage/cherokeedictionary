...
<html>
    ...
    <body>
        ...
        <div id="show-likespreadsheets" class="content scaffold-show" role="main">
            ...
            <f:display bean="likespreadsheets" />
            <g:form resource="${this.likespreadsheets}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.likespreadsheets}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
