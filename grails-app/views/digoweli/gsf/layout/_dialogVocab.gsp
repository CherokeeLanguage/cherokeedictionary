...
<g:else>
    ...
    <g:each in="${dialogs}">
        <div style="display:table-row">
            ...
            <div style="display:table-cell;padding-right:20px">${SyllabaryUtil.mixedTransliteration(it.dialog)}<g:if test="${showPhonetic ?: false}"><br/><g:redSpan>${it.dialog}</g:redSpan></g:if></div>
